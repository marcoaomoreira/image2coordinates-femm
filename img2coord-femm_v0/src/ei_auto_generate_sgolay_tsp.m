...
function ei_auto_generate_sgolay_tsp(image,convert,femm_path)
...
openfemm;
newdocument(1);
ei_probdef('millimeters', 'planar', 1.e-8, 0, 30);
...
ymenor = menor2(1,2);
xmenor = menor2(1,1);
ei_drawrectangle(xmaior,ymaior,xmenor,ymenor)
%close all
[pathstr,name,ext]=fileparts(mfilename('fullpath'));
addpath(genpath(pathstr));
ei_saveas([pathstr,'\Filename.FEC']) 
ei_createmesh;
end